...
class AuthController extends BaseController
{
    ...
    {
        // Jika sudah login, redirect ke dashboard/admin sesuai role
        if ($this->isLoggedIn()) {
        ...
        // Use the auth/login view we already have
    ...
    public function loginCheck()
    {
        ...
        // ambil data username di database yang sama dengan inputan user
        ...
        if ($check) { // cek apakah user ditemukan
            ...
            if (password_needs_rehash($check->password, PASSWORD_DEFAULT)) {
                ...
                // user_id or primary key may be user_id
                $this->auth->updatePassword($check->user_id ?? $check->id ?? null, $newHash);
            }
